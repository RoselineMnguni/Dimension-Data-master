...
{
    public partial class DimensionDatabaseContext : DbContext
    {
        public DimensionDatabaseContext()
        {
        }

        public DimensionDatabaseContext(DbContextOptions<DimensionDatabaseContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Initial Catalog=DimensionDatabase;Data Source=WALVIS-PC\\MSSQLSERVER2019;Trusted_Connection=true");
            }
        }
